<?php
// <!-- Doesn't work for some reason. Error : Route [oauthCallback] not defined.-->
...
class gCalendarController extends guest\CalendarController
{
    protected $client;
    ...
    public function __construct()
    {
        ...
        // $client->setRedirectUri(URL::to('/calendar') . '/oauth2callback');

...
<div class="container">
    ...
    <!-- Jumbotron Header -->
    <header class="jumbotron my-4" style="background: linear-gradient(rgba(52, 220, 147, 0.7), rgba(52, 220, 147, 0.1)),url('<?php echo e(asset('storage/images/nature4.jpg')); ?>') fixed center center; background-size: cover;">

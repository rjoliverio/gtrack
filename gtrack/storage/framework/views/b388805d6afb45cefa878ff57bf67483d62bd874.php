  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/dashboard">
        <img src="<?php echo e(asset('storage/images/gtrack-logo-3.png')); ?>" width="150" class="img-fluid "alt="" >
      </a>
      ...
      <li class="nav-item <?php echo e((request()->is('admin/tracker/*') || request()->is('admin/tracker')) ? 'active' : ''); ?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo e(Auth::user()->userdetail->fname); ?> <?php echo e(Auth::user()->userdetail->lname); ?></span>
                <img class="img-profile rounded-circle" src=<?php echo e(asset('storage/images/uploads/'.Auth::user()->userdetail->image)); ?>>
              </a>
...
<?php /**PATH C:\Users\rjoli\Desktop\gtrack\gtrack\resources\views/layouts/admin_master.blade.php ENDPATH**/ ?>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <!-- /.container -->
  <section class="jumbotron text-center" id="anno1" style="background: linear-gradient(rgba(52, 220, 147, 0.7), rgba(52, 220, 147, 0.1)),url('{{asset('storage/images/nature4.jpg')}}') fixed center center; background-size: cover;">

                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$driver->userdetail->address->street.' '.$driver->userdetail->address->barangay.' '.$driver->userdetail->address->town}}
                            </td>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$admin->userdetail->address->street.' '.$admin->userdetail->address->barangay.' '.$admin->userdetail->address->town}}
                            </td>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$inactive->userdetail->address->street.' '.$inactive->userdetail->address->barangay.' '.$inactive->userdetail->address->town}}
                            </td>
                        ...
                        <form action="/admin/employees/reactivate/{{ $inactive->user_id }}" method="POST">
                            <div class="modal fade" id="Modal{{$inactive->user_id}}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Reactivate Driver Account
                                            </h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>

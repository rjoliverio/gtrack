        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('admin.employees.store')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="gender" class="custom-select form-control @error('gender') is-invalid @enderror" name="gender" required autocomplete="gender" autofocus>
                    ...
                    <div class="form-group row">
                        <label for="gender" class="col-md-4 col-form-label text-md-right">{{ __('Employee Type') }}</label>

                        <div class="col-md-6">
                            <select id="user_type" class="custom-select form-control @error('user+type') is-invalid @enderror" name="user_type" required autocomplete="gender" autofocus>
